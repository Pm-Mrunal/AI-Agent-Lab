...
**Configuration:** (Add user input block and create a new user input)
...
**Prompt Example:**
> Based on the user's question, come up with a query for a vector database that will help me get the correct answer to the question. Return on the query and nothing else"
...
**Outputs:**
- `retrieved_context` – relevant content extracted from the document saved as variable.
...
**Prompt Example:**
> “The user has asked a question related to LifeLabs and Lab diagnostic testing in Ontario. We have queried a vector database to get the relevant data that can help answer the question. Based on the query result, asnwer the users question.  
>  
...
**Author:** Mrunal Surve
**Lab:** AI Agent Lab #1 – “Ask the Docs” Chat Bot  
